...
/// </summary>
public sealed record FinalEffectSnapshot(FinalEffectSurfaceKind SurfaceKind)
{
    public static FinalEffectSnapshot Empty { get; } = new(FinalEffectSurfaceKind.None);

    public static FinalEffectSnapshot Create(FinalEffectSurfaceKind surfaceKind) => new(surfaceKind);
}
