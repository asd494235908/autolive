...
为公共配置增加 namespace 级、版本化 JSON Schema Draft 2020-12 注册、校验、dry-run 和原子发布，保留敏感字段拒绝作为另一层安全门禁。
...
- [ ] 根据实际基线新增/迁移 config_namespaces、config_schema_versions 和 public_config_revisions 事实。
