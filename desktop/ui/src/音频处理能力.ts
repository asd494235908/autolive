export type AudioCapabilityStatus = 'disabled' | 'configured' | 'runtime' | 'ready';
...
export function buildAudioCapabilityRows(
  ...
  return [
    ...
    { key: 'dry_wet_percent', label: '干湿比', value: finiteOrNull(values.dry_wet_percent), unit: '%', status: configuredStatus, description: '契约字段；当前 FFmpeg 未映射时保持配置值' },
