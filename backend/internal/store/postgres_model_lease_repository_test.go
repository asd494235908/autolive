...
func TestPostgresRepositoryCreateModelLeaseUsesNormalizedTransaction(t *testing.T) {
	...
	mock.ExpectExec(regexp.QuoteMeta("INSERT INTO audit_outbox (")).WithArgs(sqlmock.AnyArg(), "audit-request:req-create-lease", sqlmock.AnyArg(), now).WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectCommit()
...
func TestPostgresRepositoryRenewModelLeaseUsesNormalizedTransaction(t *testing.T) {
	...
	mock.ExpectExec(regexp.QuoteMeta("INSERT INTO audit_outbox (")).WithArgs(sqlmock.AnyArg(), "audit-request:req-renew-lease", sqlmock.AnyArg(), now).WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectCommit()
...
func TestPostgresRepositoryReleaseModelLeaseUsesNormalizedTransaction(t *testing.T) {
	...
	mock.ExpectExec(regexp.QuoteMeta("INSERT INTO audit_outbox (")).WithArgs(sqlmock.AnyArg(), "audit-request:req-release-lease", sqlmock.AnyArg(), now).WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectCommit()
...
func TestPostgresRepositoryReclaimModelLeaseUsesNormalizedTransaction(t *testing.T) {
	...
	mock.ExpectExec(regexp.QuoteMeta("UPDATE model_leases SET status = $2, released_at = $3 WHERE id = $1")).WithArgs("lease_1", controlplane.ModelLeaseStatusReleased, now).WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectExec(regexp.QuoteMeta("INSERT INTO audit_outbox (")).WithArgs(sqlmock.AnyArg(), "audit-request:req-reclaim-lease", sqlmock.AnyArg(), now).WillReturnResult(sqlmock.NewResult(1, 1))
	mock.ExpectCommit()
